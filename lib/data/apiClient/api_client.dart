...
import 'package:shaga_chat/core/utils/progress_dialog_utils.dart';
import 'package:shaga_chat/data/models/postRegister/post_post_register_resp.dart';
  ...
  Future<PostPostRegisterResp> postRegister({
    ...
    try {
      ...
      if (_isSuccessCall(response)) {
        return PostPostRegisterResp.fromJson(response.body);
      } else {
        throw response.body != null
            ? PostPostRegisterResp.fromJson(response.body)
